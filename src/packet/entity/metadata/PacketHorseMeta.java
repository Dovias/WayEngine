...
public final class PacketHorseMeta extends AbstractPacketHorseMeta<PacketHorseMeta> {
    ...
    public @NotNull PacketHorseMeta setVariant(Integer variant) {
    ...
    @Override
    protected @NotNull PacketHorseMeta self() {
        return this;
    }
}
