...
public final class PacketAgeableEntityMeta extends AbstractPacketAgeableEntityMeta<PacketAgeableEntityMeta> {
    ...
    @Override
    protected @NotNull PacketAgeableEntityMeta self() {
        return this;
    }
}
